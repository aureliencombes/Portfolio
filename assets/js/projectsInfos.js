const project = []
    ...
    project[3] = {
        image : 'url("assets/img/project/alainalaric.jpg")',
    ...
    project[8] = {
        image : 'url("assets/img/project/guess_who.jpg")',
        title : '3D Guess Who',
        text : 'Made for a school project in CSS 3D.',
        linkText : 'test it',
        link : 'https://aureliencombes.github.io/Guess_Who_3D/',
        };

    project[9] = {
        image : 'url("assets/img/project/canvas.jpg")',
        title : 'Little canvas game',
        text : "just a simple 2D game in canvas, you can't do many things. still in developpement",
        linkText : 'test it',
        link : 'https://aureliencombes.github.io/Canvas-Game/',
        };